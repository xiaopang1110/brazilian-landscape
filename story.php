...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Story <small></small></h1>
        <!-- end page-header -->
        ...
        if(isset($_GET['Axl3j4g6t']) && $_GET['Axl3j4g6t'] !== "")
        {
            ...
            {
                $search = $_GET['search'];
                $qutotal = $admin->getstory($search, "searchtotal", "none", "none",$cat_id,"yes");
                $query = $admin->getstory($search, "search", $start, $per_page,$cat_id,"yes");
            }
            else
            {
                $query = $admin->getstory("none", "none", $start, $per_page,$cat_id,"yes");
                $qutotal = $admin->getstory("none", "total", "none", "none",$cat_id,"yes");
            }
        }
        else
        {
            ...
            {
                $search = $_GET['search'];
                $qutotal = $admin->getstory($search, "searchtotal", "none", "none","","no");
                $query = $admin->getstory($search, "search", $start, $per_page,"","no");
            }
            else
            {
                $query = $admin->getstory("none", "none", $start, $per_page,"","no");
                $qutotal = $admin->getstory("none", "total", "none", "none","","no");
            }
        ...
        ?>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <a href="story.php" class="btn btn-sm btn-success" >Reset</a>
                </div>
            </div>
                                            ...
                                            foreach ($query as $res)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php 
                                                        foreach ($category as $val)
                                                        {
                                                            if($res['category_id'] == $val['category_id']) {
                                                                echo $val['name'];
                                                            }
                                                        }
                                                    ?></td>
...
<script>
    ...
    function selectcatid(id)
    {
        ...
        { ?>
        window.location="story.php?Axl3j4g6t="+id +"&DYlN1b0Jn=<?php echo $_GET['DYlN1b0Jn'];?>&page=<?php echo $_GET['page'];?>";
        <?php }
        elseif(isset($_GET['page']))
        { ?>
        window.location="story.php?Axl3j4g6t="+id +"&page=<?php echo $_GET['page'];?>";
        <?php }
        elseif(isset($_GET['DYlN1b0Jn']))
        { ?>
        window.location="story.php?Axl3j4g6t="+id +"&DYlN1b0Jn=<?php echo $_GET['DYlN1b0Jn'];?>";
        <?php }
        else
        { ?>
        window.location="story.php?Axl3j4g6t="+id;
        <?php }
        ?>
    }
            ...
            $.ajax({
                ...
                success: function (data)
                {
                    if (data)
                    {
                        ...
                        elseif(isset($_GET['Axl3j4g6t']))
                        { ?>
                        window.location="story.php?Axl3j4g6t=<?php echo $_GET['Axl3j4g6t'];?>";
                        <?php }
                        elseif(isset($_GET['page']))
                        { ?>
                        window.location="story.php?page=<?php echo $_GET['page'];?>";
                        <?php }
                        else
                        { ?>
