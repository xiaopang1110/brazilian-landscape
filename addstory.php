    ...
    if($getuser->rights == 1) {
    	if(isset($_FILES['file']['name']) && $_FILES['file']['name']!="")
	    {
	        ...
	        if(move_uploaded_file($tmp_file,$file_path))
	        {
	            extract($_REQUEST);
		        $time = time();
		        $addstory = $admin->insertstory($category,$story_title,$story,$imagename);
		        if ($addstory) 
		        {
			        ?>
			            <script>
			                window.location = 'addstory.php';
			            </script>
			        <?php
				} 
				else 
	    ...
	    else
	    {
	    	extract($_REQUEST);
		    $time = time();
		   	$addstory = $admin->insertstory($category,$story_title,$story,"");
		    if ($addstory) 
		    {
			    ?>
			            <script>
...
<head>
	<meta charset="utf-8" />
	<title>Story Book | Add Story</title>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-wysiwyg-2">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Add Story</h4>
                        </div>
                			...
                			<div class="col-md-6">
                				<form  name="addquestion" method="POST" enctype="multipart/form-data">
			                        ...
			                        <div class="form-group">
			                            ...
			                            <div class="col-md-10">
			                                <input type="text" name="story_title" class="textarea form-control"  placeholder="Story Title" >
			                            </div>
			                        </div>
			                        ...
			                        <div class="form-group">
			                            ...
			                            <div class="col-md-10">
			                                <textarea class="textarea form-control" name="story" id="editor1" placeholder="Enter Story ..." rows="12"></textarea>
			                            </div>
			                        </div>
			                        ...
			                        <div class="form-group">
			                            ...
			                            <div class="col-md-10">
			                                <input type="submit" name="addstory" value="Add Story" class="btn btn-sm btn-success">
			                            </div>
			                        </div>
