    ...
    if($getuser->rights == 1) {
    	if(isset($_FILES['file']['name']) && $_FILES['file']['name']!="")
	    {
	        ...
	        if(move_uploaded_file($tmp_file,$file_path))
	        {
	            extract($_REQUEST);
		        $time = time();
		        $addhomebanner = $admin->inserthomebanner($story,$banner_title,$imagename);
		        if ($addhomebanner) 
		        {
			        ?>
			            <script>
	    ...
	    else
	    {
	    	extract($_REQUEST);
		    $time = time();
		   	$addhomebanner = $admin->inserthomebanner($story,$banner_title,"");
		    if ($addhomebanner) 
		    {
			    ?>
			            <script>
...
<head>
	<meta charset="utf-8" />
	<title>Story Book | Add Home Banner</title>
...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Add Home Banner</h1>
			<!-- end page-header -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-wysiwyg-2">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Add Home Banner</h4>
                        </div>
                        ...
                        <div class="panel-body panel-form">
                			<div class="col-md-6">
                				<form  name="addquestion" method="POST" enctype="multipart/form-data">
                					...
                					<div class="form-group">
			                            <label class="col-md-2 control-label">Select Story: </label>
			                            <div class="col-md-10">
			                        ...
			                        <div class="form-group">
			                            ...
			                            <div class="col-md-10">
			                                <input type="text" name="banner_title" class="textarea form-control"  placeholder="Banner Title" >
			                            </div>
			                        </div>
			                        ...
			                        <div class="form-group">
			                            ...
			                            <div class="col-md-10">
			                                <input type="submit" name="addhomebanner" value="Add Home Banner" class="btn btn-sm btn-success">
			                            </div>
			                        </div>
