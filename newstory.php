...
<head>
    <meta charset="utf-8" />
    <title>Story Book | User Story</title>
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">User Story <small></small></h1>
        <!-- end page-header -->
        ...
        {
            $search = $_GET['search'];
            $qutotal = $admin->getnewstory($search, "searchtotal", "none", "none");
            $query = $admin->getnewstory($search, "search", $start, $per_page);
        }
        else
        {
            $query = $admin->getnewstory("none", "none", $start, $per_page);
            $qutotal = $admin->getnewstory("none", "total", "none", "none");
        }
        ...
        ?>
            ...
            <div class="row">
                <!-- <div class="col-md-1">
                    <a href="addstory.php" class="btn btn-sm btn-success" >Add New Story</a>
                </div> -->
                <!-- <div class="col-md-2">
                    <select class="form-control m-b-2" name="cat_id" onchange="selectcatid(this.value)">
                        <option value="" readonly="">Select Category</option>
                        <?php
                        foreach ($category as $val)
                        {
                            $qstring1="cat_id=".$val['category_id'];
                            $enc_str1=$admin->encrypt_decrypt("encrypt",$qstring1);
                            if($_GET['Axl3j4g6t']==$enc_str1)
                            { ?>
                                <option value="<?php echo $enc_str1;?>" selected><?php echo $val['name'];?></option>
                            <?php }
                            else
                            { ?>
                                <option value="<?php echo $enc_str1;?>"><?php echo $val['name'];?></option>
                            <?php }
                        }
                        ?>
                    </select>
                ...
                <div class="col-md-2">
                    <a href="newstory.php" class="btn btn-sm btn-success" >Reset</a>
                </div> -->
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">User Story</h4>
                        </div>
                                ...
                                <tbody>
                                    <?php
                                        if($query) 
                                        {
                                            ...
                                            {
                                                $qstring="storyid=".$res['story_id'];
                                                $enc_str=$admin->encrypt_decrypt("encrypt",$qstring);
                                                ?>
                                                <tr>
                                                    <td><?php echo $res['story_id'];?></td>
                                                    ...
                                                    <td>
                                                        <?php
                                                            ...
                                                            {
                                                            ?>
                                                                <img src="uploads/<?php echo $res['image'];?>" style="width: auto;height: 110px;">
                                                            <?php
                                                            }
                                                            ?>
                                                    </td>
                                                    <td><?php echo $res['story_title'];?></td>
                                                    <td style="width: 110px;height: 30px !important;overflow: hidden;text-overflow: ellipsis; "><?php echo $res['story'];?></td>
                                                    <td>
                                                        <?php
                                                            if($getuser->rights == 1)
                                                            {
                                                                ...
                                                                {
                                                                    ?>
                                                                    <small></small> <input type="checkbox" data-render="switchery" data-theme="default" checked  onchange="changeactive('<?php echo $enc_str; ?>',0)"/>
                                                                    <?php
                                                                }
                                                                else{
                                                                    ?>
                                                                    <small></small> <input type="checkbox" data-render="switchery" data-theme="default" onchange="changeactive('<?php echo $enc_str; ?>',1)"  />
                                                                    <?php
                                                                }
                                                            }
                                                            else
                                                            {
                                                                ...
                                                                {
                                                                    ?>
                                                                    <small></small> <input type="checkbox" data-render="switchery" data-theme="default" checked  onchange="demo()"/>
                                                                    <?php
                                                                }
                                                                else{
                                                                    ?>
                                                                    <small></small> <input type="checkbox" data-render="switchery" data-theme="default" onchange="demo()"  />
                                                                    <?php
                                                                }
                                                            }
                                                    ...
                                                    <td>
                                                        <?php
                                                            ...
                                                            {
                                                                ?>
                                                                <!-- <a href="editstory.php?Axl3j4g6t=<?php echo $enc_str ?>" > <span class="fa fa-edit" style="font-size: 18px;color: #00acac;"> Edit</span></a> --> &nbsp;&nbsp;&nbsp;&nbsp;
                                                                <a href="#" onclick="deletestory('<?php echo $enc_str; ?>')"><span class="fa fa-trash-o" style="font-size: 18px;color: #761c19"> Delete</span></a>
                                                                <?php
                                                            }
                                                            else
                                                            {
...
<script>
    ...
    function selectcatid(id)
    {
        ...
        { ?>
        window.location="newstory.php?Axl3j4g6t="+id +"&DYlN1b0Jn=<?php echo $_GET['DYlN1b0Jn'];?>&page=<?php echo $_GET['page'];?>";
        <?php }
        elseif(isset($_GET['page']))
        { ?>
        window.location="newstory.php?Axl3j4g6t="+id +"&page=<?php echo $_GET['page'];?>";
        <?php }
        elseif(isset($_GET['DYlN1b0Jn']))
        { ?>
        window.location="newstory.php?Axl3j4g6t="+id +"&DYlN1b0Jn=<?php echo $_GET['DYlN1b0Jn'];?>";
        <?php }
        else
        { ?>
        window.location="newstory.php?Axl3j4g6t="+id;
        <?php }
        ?>
    }
            ...
            $.ajax({
                ...
                success: function (data)
                {
                    if (data)
                    {
                        ...
                        elseif(isset($_GET['Axl3j4g6t']))
                        { ?>
                        window.location="newstory.php?Axl3j4g6t=<?php echo $_GET['Axl3j4g6t'];?>";
                        <?php }
                        elseif(isset($_GET['page']))
                        { ?>
                        window.location="newstory.php?page=<?php echo $_GET['page'];?>";
                        <?php }
                        else
                        { ?>
    ...
    function changeactive(id,value)
    {
        ...
        if(x) {
            $.ajax({
                type: "POST",
                url: "ajax/changestorystatus.php",
                ...
                success: function (data)
                {
                    if (data)
                    {
                        ...
                        if(isset($_GET['page']) && isset($_GET['Axl3j4g6t']))
                        { ?>
                        window.location="newstory.php?Axl3j4g6t=<?php echo $_GET['Axl3j4g6t'];?>&page=<?php echo $_GET['page'];?>";
                        <?php }
                        elseif(isset($_GET['Axl3j4g6t']))
                        { ?>
                        window.location="newstory.php?Axl3j4g6t=<?php echo $_GET['Axl3j4g6t']?>";
