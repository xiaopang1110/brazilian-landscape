...
if(isset($_POST['edithomebanner']))
{
    if($getuser->rights == 1) {
    	if(isset($_FILES['file']['name']) && $_FILES['file']['name']!="")
	    {
	        ...
	        $imagename= "homebanner_".time().".".$ext;
	        ...
	        if(move_uploaded_file($tmp_file,$file_path))
	        {
	            extract($_REQUEST);
		        $time = time();
		        $edithomebanner = $admin->edithomebanner($homebanner_id,$story,$banner_title,$imagename);
		        if ($edithomebanner) 
		        {
			        ?>
			            <script>
			                window.location = 'edithomebanner.php?Axl3j4g6t='<?php echo $_GET['Axl3j4g6t'];?>;
			            </script>
			        <?php
				} 
				else 
	    ...
	    else
	    {
	    	extract($_REQUEST);
		    $time = time();
		   	$edithomebanner = $admin->edithomebanner($homebanner_id,$story,$banner_title,"none");
		    if ($edithomebanner) 
		    {
			    ?>
			            <script>
...
<head>
	<meta charset="utf-8" />
	<title>Story Book | Edit Home Banner</title>
...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Edit Home Banner</h1>
			<!-- end page-header -->
			...
			<div class="row">
                ...
                <?php
                	...
                	$homebannerdetail=$admin->gethomebannerbyid($storyid);
                ?>
                        ...
                        <div class="panel-body panel-form">
                			<div class="col-md-6">
                				<form  name="addquestion" method="POST" enctype="multipart/form-data">
                					<input type="hidden" name="homebanner_id" value="<?php echo $homebannerdetail->homebanner_id;?>">
                					<input type="hidden" name="oldimage" value="<?php echo $homebannerdetail->image;?>">
                					...
                					<div class="form-group">
			                            ...
			                            <div class="col-md-10">
			                                <select class="form-control" name="story" onchange="getcategory(this.value)" required="" style="border: 1px solid #ccd0d4 !important;">
			                                	<option value="">Select Category</option>
			                                    <?php
			                                    	$story = $admin->getallstory();
			                                        foreach ($story as $val)
			                                        {
			                                        	if($val['story_id'] == $homebannerdetail->story_id)
			                                        	{
			                                        		?>
				                                            <option value="<?php echo $val['story_id'];?>" selected><?php echo $val['story_title'];?></option>
				                                            <?php
			                                        	}
			                                        	else
			                                        	{
			                                        		?>
				                                            <option value="<?php echo $val['story_id'];?>"><?php echo $val['story_title'];?></option>
				                                            <?php
			                                        	}
			                                        }
			                                    ?>
			                        ...
			                        <div class="form-group">
			                            ...
			                            <div class="col-md-10">
			                                <input type="text" name="banner_title" class="form-control" value="<?php echo $homebannerdetail->banner_title;?>"  placeholder="Banner Title" >
			                            </div>
			                        </div>
			                        ...
			                        <div class="form-group">
			                            ...
			                            <div class="col-md-10">
			                                <img src="uploads/<?php echo $homebannerdetail->image;?>" style="width: 150px">
			                            </div>
			                        </div>
			                        <div class="form-group">
			                            <div class="col-md-12" style="margin-top: 30px">
			                        ...
			                        <div class="form-group">
			                            ...
			                            <div class="col-md-10">
			                                <input type="submit" name="edithomebanner" value="Edit Home Banner" class="btn btn-sm btn-success">
			                            </div>
			                        </div>
